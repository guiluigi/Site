			...
			<div class="inner narrow">
				...
				<form class="grid-form" action="" method="post">
					...
					<div class="form-control">
						...
						Inline Keybord <input name="reply_markup" value='[[{"text":"Robô E D","url":"https://telegram.me/EDRobot"},{"text":"Sete Zoom","url":"https://telegram.me/SeteZoomBot"},{"text":"SimSimi","url":"https://telegram.me/SimiRobot"}]]' id="name" type="text">
				...
				<?php
					...
					{
						$token = '265130205:AAFsTSM230glzZ2cMVvo7RNcCv8KJlTBzjU'; //HERE TOKEN
