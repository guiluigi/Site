...
var exibe = '<link rel="stylesheet" id="theme-switch" href="css/style.css">';
if ((hora >= 6) && (hora < 12)) {
    exibe = '<link rel="stylesheet" id="theme-switch" href="css/style-light.css">'
} else {
    if ((hora >= 12) && (hora < 19)) {
        exibe = '<link rel="stylesheet" id="theme-switch" href="css/style-light.css">'
    }
    ...
    function oa(a, b, c, d, e) {
        ...
        while (f = m[n++]) {
            if (d && r.inArray(f, d) > -1) {
                ...
                if (j = r.contains(f.ownerDocument, f), g = la(l.appendChild(f), "script"), j && ma(g), c) {
                    k = 0;
                    while (f = g[k++]) {
    ...
    o.cors = !!Pb && "withCredentials" in Pb, o.ajax = Pb = !!Pb, r.ajaxTransport(function(b) {
        ...
        if (o.cors || Pb && !b.crossDomain) {
            return {
                send: function(e, f) {
                    var g, h = b.xhr();
                    if (h.open(b.type, b.url, b.async = true, b.username = null, b.password = null), b.xhrFields) {
